...
import { Download, ChevronDown, Image, FileCode, FileJson, Share2, Loader2 } from 'lucide-react';
...
export function ExportButton({ onExport, disabled = false, isExporting = false, className }: ExportButtonProps) {
  ...
  return (
    <div className={cn("relative", className)} ref={dropdownRef}>
      ...
      >
        ...
        {!isExporting && <ChevronDown className={cn("h-4 w-4 transition-transform", isOpen && "rotate-180")} />}
      </button>
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  exportingFormat !== null ? "opacity-50 cursor-not-allowed" : "hover:bg-gray-50"
                )}
              >
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-900">
                    {isFormatExporting ? 'Exporting...' : EXPORT_FORMATS[format].label}
                  </p>
